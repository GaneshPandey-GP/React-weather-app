    ...
    <>
      {currentWeather.country ? (
        <div className="row ">
          ...
          <div
            className="col-sm-4 ml-4"
            style={{
              position: "relative",
              top: "-190px",
              boxShadow: "5px 5px 12px #fff",
            }}
          >
            <WeaklyCard name={probs.name} />
          </div>
        </div>
      ) : (
       <div className="container ml-5" style={{marginTop:"15%",textAlign:"center",fontSize:"30px",color:"#362966",fontWeight:600}}>
